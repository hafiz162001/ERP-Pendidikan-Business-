...
const PortofolioRecommendationCard = ({ portofolio }) => {
  const dummyData = { ...portofolio };

  return (
    <div className="card border-0 rounded-3 shadow-sm mb-20">
      ...
      <div className="card-body">
        ...
        /> */}
        <p>
          <span className="text-danger">❤</span> {dummyData.jumlah_like} suka
        </p>
      </div>
    </div>
  );
...
export default PortofolioRecommendationCard;
