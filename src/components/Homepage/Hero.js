...
// import homepagePerson from "../../assets/img/homepage_person.png";
import homepagePerson from "../../assets/img/homepage_person.png";
import homepageShow from "../../assets/img/homepage_show.png";

function Hero() {
  return (
    <section className="hero__area hero__height hero__height-2 d-flex align-items-center bg-cream-bb p-relative fix">
        ...
        <div className="hero__content-wrapper">
          <div className="row align-items-center">
            <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div className="hero__content hero__content-2 p-relative z-index-1 mt-50">
                <h1 className="heading">
                <span className="link-red-bb">Baker<span className="spice">Spice</span></span><br></br><br></br>
                  Belajar Membuat dan mengelola bisnis, keuangan dan manajemen startup kuliner.
                </h1>
                <p className="hero-subtext">
                akses 50+ materi pelajaran GRATIS
                </p>
                <div className="mt-5 mb-5">
                  <Link to="/freecourse">
                    <button className="btn btn-altdanger mr-10">
                      Lihat Kelas
                    </button>
                  </Link>
                  <Link to="/portofolio">
                    <button className="btn btn-altdanger">
                      Lihat Portofolio
                    </button>
                  </Link>
                </div>
                {/* <div className="hero__search">
                  <form action="#">
                    <div className="hero__search-input mb-10">
                      <input type="text" placeholder="Ingin belajar apa ?" />
                      <button type="submit">
                        <i>
                ...
                Belajar seru di Bakerspice Academy untuk membangun portofolio bidang kuliner, f&b dan bisnis UMKM
              ...
              <div className="hero__thumb-wrapper mb--120">
                <div className="hero__thumb-2 scene">
                  ...
                  >
                    ...
                    <div className="hero__promotion-text">
                      <h5>
                        <span className="counter">1</span>0
                      </h5>
                      <p>Course Selesai</p>
                    </div>
                  </div>
